...
\begin{document}
\definecolor{coolblack}{rgb}{0.0, 0.18, 0.18}
\name{Aaryan Raj Saxena}
\tagline{Computer Science Graduate, IIIT Delhi}
% \photo{2.8cm}{Globe_High}
\personalinfo{%
  % Not all of these are required!
  % You can add your own with \printinfo{symbol}{detail}
  \email{aaryan20004@iiitd.ac.in}
  \phone{+91-9818481187}
...
\cvevent{PHP Developer Intern}{Mehaar Technologies}{May 2018 -- Jun 2018}{}
\begin{itemize}
...
\cvevent{Front End Developer Intern}{Meghna Plastics}{Jun 2018 }{}
\begin{itemize}
...
\cvevent{Real Time Chat Application}
